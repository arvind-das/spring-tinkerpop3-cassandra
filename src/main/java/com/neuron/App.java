...
//            mgmt.buildIndex("edges", Edge.class).addKey(reason).addKey(place).buildMixedIndex(mixedIndexName);
     ...
     * a command line.  Use one of the other methods on this class ({@link )}
    ...
    public static void main(String args[]) {
       /* if (null == args || 1 != args.length) {
        ...
        TitanGraph g = TitanFactory.open("/home/arvind/IdeaProjects/titan-tinker-cassandra/src/main/resources/application-development.properties");
        load(g);
        g.close();
    }
}
